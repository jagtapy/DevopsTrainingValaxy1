...
``` 
OR
 enable user authentication((Master & Slave))
 
 ```sh 
vi /etc/ssh/ssh_config
uncomment passwordauthentication section

vi /etc/ssh/sshd_config
uncomment "passwordauthentication yes" section
comment "passwordauthentication no" section
```
 
 Restart services(Master & Slave)
  ```sh 
...
create a group like below (what i followed)
[Web_server]
IP_ADD1
IP_ADD2
```
